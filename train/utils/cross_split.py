...
def print_fold_groups(df, group_col, num_folds, fold_col='fold'):
...
def print_kfolds(images_flare, images_urban, images_fire, num_folds):
    print("=== Flare dataset folds ===")
    print_fold_groups(images_flare, num_folds, 'continent')

    print("\n=== Urban dataset folds ===")
    print_fold_groups(images_urban, num_folds, 'city')
...
def create_folds(images_flare, images_urban, images_fire, num_folds):
    ...
    # print_kfolds(images_flare, images_urban, images_fire, num_folds)
